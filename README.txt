...
1. Building will fail unless you put the needed keys and secrets required by all references to *user_creds.js*.
...
Alternatively you can also run ```tsc`` on the project folder and grab the transpiled folder.
